...
namespace
{
    ...
    // To know where the window was when swapping to fullscreen
    RECT oldWinRect;
};
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"Messing_Around_in_DX11WindowClass";
    ...
    case WM_SYSKEYDOWN:
        if (wParam == VK_RETURN && (lParam & 0x60000000) == 0x20000000)
        {
            ...
            if (s_fullscreen)
            {
                ...
                SetWindowPos(hWnd, HWND_TOP, oldWinRect.left, oldWinRect.top, width, height, SWP_NOMOVE | SWP_NOZORDER | SWP_FRAMECHANGED);
            }
            else
            {
                GetClientRect(hWnd, &oldWinRect);
